...
String postId = Uuid().v4();
 ...
 TextEditingController descriptionTextEdittingController = TextEditingController();
TextEditingController locationTextEdittingController = TextEditingController();
...
cancelUpload(){
  ...
  clearPostInfo(){
    locationTextEdittingController.clear();
    descriptionTextEdittingController.clear();
    setState(() {
      file = null;
    });
}
...
getUserCurrentLocation() async {
  ...
  locationTextEdittingController.text = specificAddress;
...
controlUploadAndSave() async {
   ...
   savePostInfoToFireStore(url:downloadUrl,location:locationTextEdittingController.text,description:descriptionTextEdittingController.text);
   locationTextEdittingController.clear();
   descriptionTextEdittingController.clear();
   setState(() {
     file = null;
        ...
        actions: [
          FlatButton(
            ...
            child: Text("Share",style: TextStyle(
              color: Colors.lightGreenAccent,fontWeight: FontWeight.bold, fontSize: 16.0,
            ),),
          )
        ],
      ),
          ...
          ListTile(
            ...
            title: Container(
              ...
              child: TextField(
                ...
                controller: descriptionTextEdittingController,
          ...
          ListTile(
            ...
            title: Container(
              ...
              child: TextField(
                ...
                controller: locationTextEdittingController,
                decoration: InputDecoration(
